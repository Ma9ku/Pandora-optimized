      ...
      {news.length > 0 ? (
        ...
        >
          ...
          <DialogContent dividers>
            ...
            <Typography gutterBottom>{news[modalIndex].description}</Typography>
          </DialogContent>
          <DialogActions>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <a
                style={{ fontSize: "21px", fontWeight: "500", color: "white" }}
              >
                {userSession ? userSession.email : "No userSession"}
              </a>
    ...
    <>
      ...
      >
        <div
          ...
          style={{ top: "30px", display: !menuOpen ? "none" : "block" }}
        >
          <IconButton
          ...
          >
            <KeyboardArrowLeftIcon
              style={{ fill: "#ffffff", fontSize: "33px" }}
            />
          </IconButton>
        </div>
