...
const HistoryPage = () => {
  ...
  useEffect(() => {
    ...
    axios.get(
      `http://10.202.20.92:9091/getEtanuHistory`,
      {
        params: {
          'page': page,
          'email': email
  ...
  const updatePage = (page) => {
    ...
    axios.get(
      `http://10.202.20.92:9091/api/v1/account/history/${_auth_user_id}/`,
      {
        params: {
          'page': page
        },
...
const SearchCard = ({ history, onRepeatSearch }) => {
  ...
  const PHOTO_URL = 'http://10.202.20.92:9091/history/';
  ...
  const handleRepeatSearchClick = async () => {
    ...
    await axios.post(
      'http://10.202.20.92:9091/api/v1/search/',
      data,
      {
