...
function Result() {
    ...
    useEffect(() => {
        ...
        if (lastRequest && lastRequest.image_name) {
            img.src = `http://10.202.20.92:9091/history/${results.image_name}`
        } else {
                                                ...
                                                <img 
                                                    src={
                                                        boxes[currentSubjectIndex].results[0].metadata.photo 
                                                            ? `http://10.202.20.92:9091/photos/${boxes[currentSubjectIndex].results[0].metadata.photo}` 
                                                            : mockPhoto
                                                    } 
                                                    alt="Udostak" 
                                                />
        ...
        <div className="card">
            <div className="photo">
                <img 
                    src={
                        image 
                            ? `http://10.202.20.92:9091/photos/${image}` 
                            : mockPhoto
                    } 
                />
